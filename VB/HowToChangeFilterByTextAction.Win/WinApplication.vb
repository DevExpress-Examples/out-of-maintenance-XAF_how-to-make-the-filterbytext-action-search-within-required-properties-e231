...
Namespace HowToChangeFilterByTextAction.Win
   Partial Public Class HowToChangeFilterByTextActionWindowsFormsApplication
      ...
      Private Sub HowToChangeFilterByTextActionWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch

...
Imports HowToChangeFilterByTextAction.Win
...
Public Class Program
    ...
    Public Shared Sub Main(ByVal arguments() As String)
        ...
        Dim _application As HowToChangeFilterByTextActionWindowsFormsApplication = New HowToChangeFilterByTextActionWindowsFormsApplication()

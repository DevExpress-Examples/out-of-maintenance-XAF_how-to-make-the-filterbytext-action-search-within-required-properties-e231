<%@ Page language="VB" AutoEventWireup="true" Inherits="ErrorPage" enableViewState="false" validateRequest="false" Codebehind="Error.aspx.vb" %>
...
You could go&nbsp;<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="javascript:history.go(-1)">back</asp:HyperLink>&nbsp;and try again
        ...
        <div id="Spacer" class="Spacer NullSize" style="height: 0px;"></div>

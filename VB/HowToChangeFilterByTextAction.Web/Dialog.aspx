<%@ Page Language="vb" AutoEventWireup="true" Inherits="DialogPage" validateRequest="false" Codebehind="Dialog.aspx.vb" %>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td style="padding:17px 17px 0px 17px">
		...
		<asp:Table ID="Table1" runat="server" Width="100%">
			...
			<asp:TableRow ID="TableRow3" runat="server">
				<asp:TableCell runat="server" ID="TableCell4" HorizontalAlign="Right" style="padding-top:8px;padding-bottom:20px;" >
					<cc2:HorizontalActionContainer ID="ObjectsCreationActionContainer" runat="server" CssClass="DialogHContainer" ContainerId="ObjectsCreation" Style="padding-right:20px;display:inline" BorderWidth="0px" CellPadding="0" CellSpacing="1">
										</cc2:HorizontalActionContainer>
					<cc2:HorizontalActionContainer ID="PopupActions" runat="server" ContainerId="PopupActions" CssClass="DialogHContainer" Style="padding-right:12px;display:inline" BorderWidth="0px" CellPadding="0" CellSpacing="1">
										</cc2:HorizontalActionContainer>
					<cc2:HorizontalActionContainer ID="DiagnosticActionContainer" runat="server" ContainerId="Diagnostic" CssClass="DialogHContainer" Style="padding-right:20px;display:inline" BorderWidth="0px" CellPadding="0" CellSpacing="1">
										</cc2:HorizontalActionContainer>
				</asp:TableCell>
			</asp:TableRow>
		</asp:Table>
